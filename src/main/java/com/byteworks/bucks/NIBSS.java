...
public class NIBSS {
    ...
    public static String transaction(String host, String port, String protocol, String terminalid, String marchantid, int transtype, String rrn, String amount, String cashback, String mcc, String iccdata, String panseqno, String track2, String marchantNameAndAddress, String currencycode, String pinblock, int ac, String key, String datetime, String card, String aid, String client, String serialno, String cellinfo, String version){
        ...
        String accounttype = "";
        switch (fromac/10) {
            case Constants.ACC_SAVINGS:
                accounttype = "SAVINGS";
                break;
            case Constants.ACC_CHEQUE:
                accounttype = "CURRENT";
                break;
            case Constants.ACC_CREDIT:
                accounttype = "CREDIT";
                break;
            default:
                accounttype = "DEFAULT";
        ...
        //send to the tms here
        String response = Notification.post(marchantNameAndAddress, terminalid, marchantid, datetime, "PURCHASE", transactionstatus, card, aid, pan, expiry, client, refno, accounttype, ""+Long.parseLong(amount), responsecode, ResponseCodes.responseCodeErrorMessage(Integer.parseInt(responsecode)), serialno, cellinfo, version);
    ...
    public static String prep(String terminalid, String host, String port, String protocol, String key1, String key2, String serialno)
    {
        ...
        try {
            ...
            if(f39 != null && f39.equals("00")){
                ...
                editor.putString("mkey", dmk); // Storing string
                editor.commit();*/
            ...
            if(f39 != null && f39.equals("00")){
                ...
                /*Editor editor = settings.edit();
                editor.putString("skey", dsk); // Storing string
                editor.commit();*/
            ...
            if(f39 != null && f39.equals("00")){
                ...
                /*Editor editor = settings.edit();
                editor.putString("pkey", dpk); // Storing string
                editor.putString("epkey", epk); // Storing string
                editor.putString("epkeykcv", kcv); // Storing string
                editor.commit();*/
            ...
            if(f39 != null && f39.equals("00")){
                ...
                for (;;) {
                    ...
                    if (f62.startsWith("03")) {//Card Acceptor Identification Code
                        ...
                        /*Editor editor = settings.edit();
                        editor.putString("merchantid", value); // Storing string
                        editor.commit();*/
                    ...
                    if (f62.startsWith("04")) {//Timeout (maximum time interval to wait for response – in seconds)
                        ...
                        /*Editor editor = settings.edit();
                        editor.putString("rtimeout", value); // Storing string
                        editor.commit();*/
                    ...
                    if (f62.startsWith("05")) {//Currency Code
                        ...
                        /*Editor editor = settings.edit();
                        editor.putString("currencycode", value); // Storing string
                        editor.commit();*/
                    ...
                    if (f62.startsWith("06")) {//Country Code
                        ...
                        /*Editor editor = settings.edit();
                        editor.putString("countrycode", value); // Storing string
                        editor.commit();*/
                    ...
                    if (f62.startsWith("07")) {//Call home time (maximum time interval idleness for which a call – home must be done – in hours)
                        ...
                        /*Editor editor = settings.edit();
                        editor.putString("callhome", value); // Storing string
                        editor.commit();*/
                    ...
                    if (f62.startsWith("52")) {//Merchant Name and Location
                        ...
                        /*Editor editor = settings.edit();
                        editor.putString("merchant", value); // Storing string
                        editor.commit();*/
                    ...
                    if (f62.startsWith("08")) {//Merchant Category Code
                        ...
                        /*Editor editor = settings.edit();
                        editor.putString("mcc", value); // Storing string
                        editor.commit();*/
