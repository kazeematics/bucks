...
import static com.byteworks.utils.Constants.LIVE_TRANSFER_URL;
...
public class Transfer {
    ...
    public static String post(String merchantaddress, String terminalId, String merchantid, String amount, String serialno, String bankcode, String accountNumber, String accountName, String phoneNumber, String requestId, String pin, String cellinfo, String version){
        ...
        String data = "<transferRequest>\n" +
                           ...
                           "<requestId>"+requestId+"</requestId>\n" + //74950968246816435865
                
                           "<destBankCode>"+bankcode+"</destBankCode>\n" +
        
                           "<amount>"+amount+"</amount>\n" +//amount in naira 10.00

                           "<transactionDesc>Agent Transfer</transactionDesc>\n" +
       
                           "<destAccount>"+accountNumber+"</destAccount>\n" +
                
                           "<beneficiaryAccountName>"+accountName+"</beneficiaryAccountName>\n" +//SAMSON KAYODE ADEBOWALE
                           
                           "<pin>"+pin+"</pin>\n" +
                
                           "<phoneNumberPri>"+phoneNumber+"</phoneNumberPri>\n" +
        ...
        try {
            ...
            URL url = new URL (LIVE_TRANSFER_URL);
